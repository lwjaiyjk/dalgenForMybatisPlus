...
public class IWalletConfig {
    ...
    private Map<String, IWalletTableConfig> tableConfigs    = new HashMap<String, IWalletTableConfig>();
    ...
    public static synchronized void init(File configFile) throws IWalletConfigException {
        ...
        try {
            ...
            // clear table config
            instance.tableConfigs = new HashMap<String, IWalletTableConfig>();
    ...
    public Map<String, IWalletTableConfig> getTableConfigs() {
        return tableConfigs;
    }
}
